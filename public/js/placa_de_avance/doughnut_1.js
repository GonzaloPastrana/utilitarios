document.addEventListener('DOMContentLoaded', function() {
    ...
    const value1= document.getElementById('valor_1').value;

    //  Setup Block
    const datapoints1= [100-value1, value1];
    
    const background_colors1=   [  'rgba(135, 135, 135, 0.2)',
                                    'rgba(48, 60, 255, 0.2)'
                                ];
    
    const border_colors1=   [  'rgba(135, 135, 135, 1)',
                                'rgba(48, 60, 255, 1)'
                            ];
    ...
    const data1= {
        labels: ['Faltante', 'Cargaron'],
        datasets: [{
            label: '# of Votes',
            data: datapoints1,
            backgroundColor: background_colors1,
            borderColor: border_colors1,
            borderWidth: 1,

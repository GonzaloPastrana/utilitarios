        ...
        <div class="bd-callout bd-callout-pink">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-6">
                        <h4 style="margin:10px;">ACTUALIZACIÓN DE ESTADO DE TECHOS</h4>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4 style="margin:10px;">ÚLTIMA ACTUALIZACIÓN</h4>
                        </div>
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-bordered table-triped table-hover">
                                    <thead class="table-danger" id="tabla_establecimientos_encabezado">
                                        <tr>
                                            <th>Estado del cielorazo</th>
                                            <th>Estado general</th>
                                            <th>Aulas con cielorazo deteriorado</th>
                                            <th>Aulas sin cielorazo</th>
                                        </tr>
                                    </thead>
...
<!-- CUADRO DE MENSAJE -->
  <div class="container d-flex justify-content-center align-items-center" style="height:200px;">
      <div class="row justify-content-center align-items-center">
            <h4 style="margin:10px;">SECCION OPCIONES_TECHOS</h4>
      </div>
  </div>
<!-- \.CUADRO DE MENSAJE -->
